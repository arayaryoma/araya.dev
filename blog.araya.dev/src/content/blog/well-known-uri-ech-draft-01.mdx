...
<figure>
  <img
    src="/assets/images/well-known-uri-ech/https-record.png"
    alt="HTTPS record のみでの ECH のイメージ図"
  />
  <figcaption>
    fig.1: HTTPS record のみで ECH を設定するときのイメージ図
  </figcaption>
</figure>
...
<figure>
  <img
    src="/assets/images/well-known-uri-ech/https-record-and-well-known-uri.png"
    alt="HTTPS record と zone factory を組み合わせた ECH のイメージ図"
  />
  <figcaption>
    fig.2: HTTPS record と zone factory を組み合わせて ECH
    を設定するときのイメージ図
  </figcaption>
</figure>
