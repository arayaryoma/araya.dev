...
thumbnail: assets/images/well-known-uri-ech/https-record-and-well-known-uri.png
---
...
import httpsRecordImage from "../../assets/images/well-known-uri-ech/https-record.png";
import { Image } from "astro:assets";

<Image
  src={httpsRecordImage}
  alt="HTTPS record のみでの ECH のイメージ図"
  caption="fig.1: HTTPS record のみで ECH を設定するときのイメージ図"
/>
...
import wellKnownUriImage from "../../assets/images/well-known-uri-ech/https-record-and-well-known-uri.png";

<Image
  src={wellKnownUriImage}
  alt="HTTPS record と zone factory を組み合わせた ECH のイメージ図"
  caption="fig.2: HTTPS record と zone factory を組み合わせて ECH を設定するときのイメージ図"
/>
